...
def load_datasets(splits):
    ...
    for split in splits:
        ...
        #'r2r_src_helper4/new_fine2/MY_%s.json'
        #'/egr/research-hlr/joslin/r4r/MY_r4r_%s.json'
        #/localscratch/zhan1624/VLN-speaker/r4r_src/new_fine2/new_r4r/R2R_%s.json
        if "/" not in split:
            with open('/localscratch/zhan1624/VLN-speaker/r4r_src_navigator/r4r_new_fine/R2R_%s.json' % split) as f:
