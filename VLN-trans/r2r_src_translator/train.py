...
'''train speaker'''
def train_speaker(train_env, tok, n_iters, log_every=500, val_envs={}, aug_env=None):
...
def train_val(test_only=False):
    ...
    if args.train == 'listener':
        ...
        train_speaker(train_env, tok, args.iters, val_envs=val_envs, aug_env=None)
    else:
        assert False
