...
# modified VLN-trans, 2022, by Yue Zhang, zhan1624@msu.edu
...
class Seq2SeqAgent(BaseAgent):
    ...
    def __init__(self, env, results_path, tok, episode_len=20, speaker=None):
        ...
        if speaker:
            self.speaker_encoder = speaker.encoder
            self.speaker_decoder = speaker.decoder
        else:
        ...
        self.split_loss = nn.BCEWithLogitsLoss(reduce=False)
        self.split_soft = nn.Softmax(dim=1)
    ...
    def rollout(self, speaker=None, train_ml=None, train_rl=True, reset=True):
        ...
        for t in range(self.episode_len):
            ...
            sub_losses += 0.0001*speaker_loss
        ...
        if train_rl:
            ...
            _, _, speaker_repr, masked_repr = self.teacher_forcing(train=True, features=features, 
                                                                    insts=initial_language_feat, target=sentence, split_mask=tmp_lanuage_mask)
        ...
        if train_ml is not None:
            ...
            self.loss += sub_losses /batch_size
    ...
    def optim_step(self):
        ...
        self.speaker_encoder.step()
        self.speaker_decoder.step()
    ...
    def save(self, epoch, path):
        ...
        all_tuple = [("vln_bert", self.vln_bert, self.vln_bert_optimizer),
                     ...
                     ("speaker_encoder", self.speaker_encoder, self.speaker_encoder_optimizer),
