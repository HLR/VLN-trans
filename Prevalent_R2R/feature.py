...
class Feature:
    ...
    def _load(self):
        ...
        elif self.feature_store == '/egr/research-hlr/joslin/img_features/ResNet-152-places365.tsv':
            self.features, self.image_h, self.image_w, self.vfov = self.__loadResNet(self.feature_store)
            self.rollout = self.rollout_single
        elif self.feature_store == '/egr/research-hlr/joslin/img_features/CLIP-ViT-B-32-views.tsv':
            self.features, self.image_h, self.image_w, self.vfov = self.__loadResNet(self.feature_store)
            self.rollout = self.rollout_single
