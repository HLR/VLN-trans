...
writer = SummaryWriter('/home/joslin/PREVALENT_R2R/tasks/R2R/snapshots/snap/original_loss')
...
def train(args, train_dataset, model, tokenizer):
    ...
    for epo in train_iterator:
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            model(inputs, attention_mask=lang_attention_mask,masked_lm_labels=labels)
            ...
            if args.max_steps > 0 and global_step > args.max_steps:
                ...
                break
        writer.add_scalar('loss', tr_loss / global_step, epo)
...
def main():
    ...
    parser.add_argument("--train_data_file", default="/home/joslin/PREVALENT_R2R/tasks/R2R/data/new_collect_traj/", type=str,

                        help="The input training data file (a text file).")

    parser.add_argument("--output_dir", default="/home/joslin/PREVALENT_R2R/tasks/R2R/snapshots/models/", type=str,
    ...
    # Landmarks
    parser.add_argument("--landmark_mask", action='store_true', default=True)
