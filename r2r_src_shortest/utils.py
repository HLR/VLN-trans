...
def load_datasets(splits):
    ...
    for split in splits:
        ...
        if "/" not in split:
            #
            # /egr/research-hlr/joslin/rxr/rxr_gt.json
            #/VL/space/zhan1624/VLN-speaker/generated_data/prevalent_aug_new.json
            with open("/VL/space/zhan1624/VLN-speaker/fake_data/data/R2R_fake_test_new.json") as f:
